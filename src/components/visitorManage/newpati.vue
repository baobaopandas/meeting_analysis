<template>
  <div class="CreateMeeting">
    <div class="tableTitle"><span class="midText">参会人员基本信息</span></div>
    <div class="MeetingInfo">
      <el-input
        ...
        class ="name"
      >
        <template slot="prepend">参会人员姓名</template>
      </el-input>
      <el-input
              ...
              class ="stuid"
      >
        <template slot="prepend">参会人员学号</template>
      </el-input>
      <el-input
              placeholder="请选择角色"
              v-model="roler"
              class ="roler"
      >
        <template slot="prepend">参会人员角色</template>
      </el-input>
      <el-input
